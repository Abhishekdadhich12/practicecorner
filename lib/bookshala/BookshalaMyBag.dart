...
class BookshalaMyBag extends StatefulWidget {
  const BookshalaMyBag({super.key});

  @override
  State<BookshalaMyBag> createState() => _BookshalaMyBagState();
}

class _BookshalaMyBagState extends State<BookshalaMyBag> {
  late double h, w;
  @override
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Text(
              'Lets fill some fantastic products',
              style:
                  TextStyle(fontSize: 16, fontFamily: 'sc', color: Colors.grey),
            ),
            SizedBox(
              height: h * 0.05,
            ),
            Container(
              ...
              child: Text(
                'Continue Shopping',
                style: TextStyle(
                    fontSize: 23, fontFamily: 'sc', color: Colors.white),
              ),
